...
export type BrokerActions = SetBrokerNameAction | SetBrokerTokenAction | SetBrokerUrlAction | SetBrokerDirectAction | SetBrokerRequestUrlAction | SetBrokerFilesUrlAction | SetBrokerImageUrlAction | ResetBrokerAction;
